...
**Appearance-based identification** supports two feature extraction backends: ResNet50 (following Körschens et al., 2018) and MegaDescriptor-L-384, a foundation model for wildlife re-identification. Both use PCA dimensionality reduction and SVM classification. Images are preprocessed using YOLOv11 for face detection and cropping, with optional background removal using SAM-based segmentation.
